...
typedef struct { //each question has a category, the question itself, the answer to the question, the dollar value its worth, and a boolean to check whether or not the question is answered.
